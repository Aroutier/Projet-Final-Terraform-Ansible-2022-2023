resource "openstack_compute_keypair_v2" "Keypair_GRA11" {
  ...
  name       = "sshkey_eductive22"  # Attention au XX 
...
resource "openstack_compute_instance_v2" "Instance_Backend_GRA11" {
  ...
  # Permet de récupérer la key de la région concernée
...
# Création d'un réseau privé
 resource "ovh_cloud_project_network_private" "network" {
    ...
    name         = "vrack_private_network_22"  # Nom du réseau
    regions      = var.regions
...
resource "ovh_cloud_project_network_private_subnet" "subnet" {
 ...
 resource "local_file" "inventory" {
  ...
  content = templatefile("inventory.tmpl",
    {
      instance_grav_first = openstack_compute_instance_v2.Instance_Backend_GRA11[0].access_ip_v4
      instance_grav_second  = openstack_compute_instance_v2.Instance_Backend_GRA11[1].access_ip_v4
      instance_grav_third = openstack_compute_instance_v2.Instance_Backend_GRA11[2].access_ip_v4
      instance_sbg_first  = openstack_compute_instance_v2.Instance_Backend_SBG[0].access_ip_v4
      instance_sbg_second  = openstack_compute_instance_v2.Instance_Backend_SBG[1].access_ip_v4
      instance_sbg_third = openstack_compute_instance_v2.Instance_Backend_SBG[2].access_ip_v4
